...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/usuarios/logar").permitAll() // De qualquer lugar, você terá acesso a
																			// login
				.antMatchers("/usuarios/cadastrar").permitAll() // e cadastro já que as rotas estão abertas
				.antMatchers(HttpMethod.OPTIONS).permitAll() /*
																 * Permite que as rotas estejam acessíveis com GET
																 * Permite saber quais métodos estão abertos na
																 * documentação da API e que estão abertos nela e é
																 * possível utilizar eles.
																 */
				...
				/*
				 * ^ Define que toda requisição tem começo, meio e fim. Uma por vez e ajuda a
				 * prevenir ataques cibernéticos e invasões com várias requisições de uma forma
				 * | Tipo quando expira o token em um site como na plataforma da Generation
				 * Brasil.
				 */
				.and().cors() /*
								 * Funciona como o '@CrossOrigins', vendo de qual porta está vindo a requisição
